...
- [ ] Tested and documented llamastack behaviour when invalid credentials are supplied for provided vector store.
- [ ] Findings written up and shared with the team (e.g. as a comment on this ticket or linked doc).
