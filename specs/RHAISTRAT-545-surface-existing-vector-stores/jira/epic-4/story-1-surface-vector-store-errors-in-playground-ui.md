...
1. Playground creation failure: if a vector store misconfiguration causes the LSD install to fail (Epic 2, Story 4), the Playground UI should surface that error clearly rather than showing a generic failure.
